    ...
    <div className="home">
      <section className="hero container">
        <div className="hero-left">
          <h1>The Creative Isaiah</h1>
          <p className="tagline"><b>Brand Identity Designer | Design Coach | Creative Powerhouse.</b></p>
          <p className="lead">Brand identity, posters, print, and digital design crafted with intention.</p>
          <div className="hero-actions">
            <a href="/portfolio" className="cta-btn">View My Work</a>
            <a href="/contact" className="cta-btn secondary">Contact</a>
          </div>
        </div>
      ...
      <section className="about-short container">
        <h2>About Me</h2>
        <p>Creative designer specializing in branding, logos, and print media. <b>Also a design coach and creative powerhouse.</b></p>
        <div className="center mt-16">
          <a href="/about" className="cta-btn secondary">Read more about me</a>
        </div>
      </section>
